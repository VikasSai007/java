...
public class BankTest {
	public static void main(String[] args) {
		...
		bankAppForm1.setAccountType("Joint");
		...
		bankAppForm2.setAccountType("Joint");
...
class Bank
{
	...
	BankAccount applyForAJointBankAccount(BankApplicationForm bankAppForm1Ref,BankApplicationForm bankAppForm2Ref) {
		System.out.println("Recieved the application from 1  : "+bankAppForm1Ref.getApplicantName() + "and form 2 :" +bankAppForm1Ref.getApplicantName()   );
		System.out.println("Creating bank Account ");
        BankAccount bankAccObj = new BankAccount(); // a blank object
		...
		long accNum = (long) value;
		bankAccObj.setAccountNumber(accNum);//real time, connect to the DB, and find out the last account number generated, and one 
		bankAccObj.setAccountHolder(bankAppForm1Ref.getApplicantName()+" "+bankAppForm2Ref.getApplicantName());
		bankAccObj.setAccountType(bankAppForm1Ref.getAccountType());
		bankAccObj.setIfscCode("BOB000000015");
		bankAccObj.setAccountBalance(3000);
