...
class ElectronicGuiter extends Guitar{
    public void use() {
	...
	void pluck() {
		System.out.println("Plucking Strings of ElectronicGuitar...");

	}
	void preset(){
	    System.out.println("Presetting of ElectronicGuitar...");
	}
} 
...
class Cello extends Violin{
	...
	void longBowling{
	    System.out.println("Long Bowling Cello...");
	}
}
