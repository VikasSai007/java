...
class EventAgency {
	public static Magician getMagician(String hint) {
		...
		else if(hint.equalsIgnoreCase("pickpocket")){
		    magician = new PickPocketMagician();
		}
		return magician;
	}
}
...
class PickPocketMagician implements Magician{
    public Magic doTrick(Account accRef) {
		System.out.println("Distracting you....");
		Magic magic = new PickPocketMagic();
		accRef.deposit(1000);
		return magic;
	}
}
...
class PickPocketMagic implements Magic
{
    	public void show() {
		System.out.println("picking your phones without your knowledge...in a magical way....");
	}
}
